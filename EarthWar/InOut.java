 ...
 * janela. Basicamente esta classe encapsula o funcionamento dos metodos da
 * clase <i>JOptionPane</i>, que pode ser usado como entrada padrao de dados.
 * <ul>
 * <li>Os metodos sao estaticos para facilitar o uso da classe
 * <li>Criacao de metodos sobrecarregados para que valores <i>default</i> possam
 * ser usados <li>Tratamento das excecoes
 * </ul>
 */
public
class InOut {
   ...
   */
public
  static String leString(String frase) {
    String Entrada;
   ...
   */
public
  static byte leByte(String frase) {
    byte num = 0;
    String Entrada;
    boolean ERRO;
    ...
    do {
      try {
        ...
        JOptionPane.showMessageDialog(
            null, "VALOR DEVE SER UM NUMERO DO TIPO " + "BYTE",
   ...
   */
public
  static short leShort(String frase) {
    short num = 0;
    String Entrada;
    boolean ERRO;
    ...
    do {
      try {
        ...
        JOptionPane.showMessageDialog(
            null, "VALOR DEVE SER UM NUMERO DO TIPO " + "SHORT",
            "   >>>      ERRO     <<<", JOptionPane.ERROR_MESSAGE);
        ERRO = true;
      }
    } while (ERRO);
...
public
  static int leInt(String frase) {
    ...
    do {
      try {
        ...
        JOptionPane.showMessageDialog(
            null, "VALOR DEVE SER UM NUMERO DO TIPO " + "INTEIRO ",
            "   >>>      ERRO     <<<", JOptionPane.ERROR_MESSAGE);
        ERRO = true;
      }
    } while (ERRO);
   ...
   */
public
  static long leLong(String frase) {
    long num = 0;
    String Entrada;
    boolean ERRO;
    ...
    do {
      try {
        ...
        JOptionPane.showMessageDialog(
            null, "VALOR DEVE SER UM NUMERO DO TIPO " + "LONG ",
            "   >>>      ERRO     <<<", JOptionPane.ERROR_MESSAGE);
        ERRO = true;
      }
    } while (ERRO);
   ...
   */
public
  static float leFloat(String frase) {
    float num = 0;
    String Entrada;
    boolean ERRO;
    ...
    do {
      try {
        ...
        JOptionPane.showMessageDialog(
            null, "VALOR DEVE SER UM NUMERO DO TIPO " + "FLOAT",
            "   >>>      ERRO     <<<", JOptionPane.ERROR_MESSAGE);
        ERRO = true;
      }
    } while (ERRO);
  ...
  /**
   * Este metodo eh para entrada de um objeto do tipo double. Tem como
   * paraametro de entrada uma String que indicara para o usuario qual o dado
   * que sera lido naquele momento por aquela caixa de texto. Le entao uma
   * String e a converte para um objeto do tipo double. O processo so para
   * quando a conversao for bem sucedida.
   *
   * @param frase que sera usada para o usuario saber qual dado sera lido
   * @return um objeto do tipo double
   */
public
  static double leDouble(String frase) {
    double num = 0;
    String Entrada;
    boolean ERRO;
    ...
    do {
      try {
        ...
        JOptionPane.showMessageDialog(
            null, "VALOR DEVE SER UM NUMERO DO TIPO " + "DOUBLE",
            "   >>>      ERRO     <<<", JOptionPane.ERROR_MESSAGE);
        ERRO = true;
      }
    } while (ERRO);
   ...
   */
public
  static char leChar(String frase) {
    String Entrada;
    boolean ERRO;
   ...
   */
public
  static void MsgDeErro(String cabecalho, String frase) {
   ...
   */
public
  static void MsgDeInformacao(String cabecalho, String frase) {
    JOptionPane.showMessageDialog(null, frase, cabecalho,
   ...
   */
public
  static void MsgSemIcone(String cabecalho, String frase) {
    JOptionPane.showMessageDialog(null, frase, cabecalho,
   ...
   */
public
  static void MsgDeAviso(String cabecalho, String frase) {
    JOptionPane.showMessageDialog(null, frase, cabecalho,
                                  JOptionPane.WARNING_MESSAGE);
  }

public
  static void Capa(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\capa.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
  
  public
  static void Introducao(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\introducao.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
  ...
  public
  static void Derrota(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\derrota.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
  ...
  public
  static void Vitoria(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\vitoria.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
  
  public static String VidaExtraComInput(String cabecalho) {
    ImageIcon capa = new ImageIcon("C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\pedirvida.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    String input = JOptionPane.showInputDialog(null, label, cabecalho, JOptionPane.PLAIN_MESSAGE);
    return input;
}
  
  public static String Palpite(String cabecalho) {
    ImageIcon capa = new ImageIcon("C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\palpite.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    String input = JOptionPane.showInputDialog(null, label, cabecalho, JOptionPane.PLAIN_MESSAGE);
    return input;
}
  ...
  public
  static void RecebeVidaExtra(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\vidaextra.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
  ...
  public
  static void SemVidaExtra(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\semvidaextra.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
  ...
  public
  static void maior(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\maior.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
   ...
   public
  static void menor(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\menor.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
