...
public
  static void Imagem(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\alunolab03\\Desktop\\Projeto\\Imgen\\capa.png");
...
public
  ...
  static void Capa(String cabecalho) {
    ImageIcon capa = new ImageIcon(
        "C:\\Users\\arthu\\OneDrive\\Área de Trabalho\\Projeto\\Imagens\\uvvflix.png");
    JLabel label = new JLabel(capa, JLabel.CENTER);
    JOptionPane.showMessageDialog(null, label, cabecalho,
                                  JOptionPane.PLAIN_MESSAGE);
  }
